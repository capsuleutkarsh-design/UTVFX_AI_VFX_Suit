...
def has_weights(local_dir):
    # The repo ships config files in some model folders, so only real weight files count as downloaded.
...
def download_huggingface_repo(repo_id, local_dir, python_exe, ignore_patterns=None, gated=False, check_dir=None):
    check_dir = check_dir or local_dir
    if os.path.exists(check_dir) and has_weights(check_dir):
...
snapshot_download(repo_id='{repo_id}', local_dir=r'{local_dir}', ignore_patterns={ignore_patterns!r})
...
MODELS = [
    ...
    {"name": "SAM ViT-H (HF)", "type": "hf_repo", "repo_id": "facebook/sam-vit-huge", "local_dir": "models/SAM", "check_dir": "models/SAM/model.safetensors"},
    ...
    {"name": "SAM 2.1 Hiera Large (SAMURAI)", "type": "file", "url": "https://dl.fbaipublicfiles.com/segment_anything_2/092824/sam2.1_hiera_large.pt", "path": "models/SAM2/sam2.1_hiera_large.pt"},
    ...
    {"name": "SAM 2 Hiera Large (HF)", "type": "hf_repo", "repo_id": "facebook/sam2-hiera-large", "local_dir": "models/SAM2", "check_dir": "models/SAM2/model.safetensors"},
    ...
    {"name": "SAM 3 Weights", "type": "hf_repo", "repo_id": "facebook/sam3", "local_dir": "models/SAM3", "check_dir": "models/SAM3/model.safetensors", "ignore_patterns": ["sam3.pt"], "gated": True},
    ...
    {"name": "VideoMaMa Fine-Tuned UNet", "type": "hf_repo", "repo_id": "SammyLim/VideoMaMa", "local_dir": "models/VideoMaMa", "check_dir": "models/VideoMaMa/unet"}
]
    ...
    for task in MODELS:
        ...
        if task["type"] == "file":
            ...
            success = download_huggingface_repo(task["repo_id"], task["local_dir"], python_exe,
                                                task.get("ignore_patterns"), task.get("gated", False),
                                                task.get("check_dir"))
