...
def download_models():
    ...
    tasks = [
        ...
        {"name": "ViTMatte Weights (HF)", "type": "hf_repo", "repo_id": "hustvl/vitmatte-small", "local_dir": "models/ViTMatte"},
        ...
        # BiRefNet (HF Repo)
        {"name": "BiRefNet", "type": "hf_repo", "repo_id": "ZhengPeng7/BiRefNet", "local_dir": "models/BiRefNet"},
