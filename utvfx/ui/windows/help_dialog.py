...
NODE_HELP_DATA = {
    ...
    "roto_to_shape": {
        ...
        "params": {
            ...
            "corner_threshold": "Where the matte's outline turns sharper than this (within a few pixels of a point), the point becomes a cusp; elsewhere it stays smooth.",
            ...
            "edge_placement": "Where the matte is cut into objects, and where the outline sits when Generate Feather is off: 0 = outer edge, 100 = solid core.",
            "generate_feather": "Puts each point where the matte is solid and its feather where the matte has faded, so Nuke's feather reproduces the soft edge.",
