...
from plugins.CompositeOutput.camera_export import export_tools as et
from plugins.CompositeOutput.camera_export.core import lens
...
def test_image_undistorter_is_called_the_way_the_roadmap_says(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("plugins.CompositeOutput.camera_export.core.proc.run_hidden", fake_run)
